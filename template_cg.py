template = '''# Computer Graphics CSC418/CSC2504 _{term}_
...
## Instructors
Prof. [{prof_name}]({prof_website})  
{prof_email}  
{prof_phone} 

**Office Hours:** {office_hour_day} {office_hour_timeslot} in {office_hour_location}
...
| Week | Topic / Event |
| ---- | :------------ |
| 1    | Introduction, Assignment 1 (Raster Images) due {A1_due} |
| 2    | Lecture 2, Assignment 2 (Ray Casting) due {A2_due} |
| 3    | Lecture 3, Assignment 3 (Ray Tracing) due {A3_due} |
| 4    | Lecture 4, Assignment 4 (Boundary Volume Hierarchy) due {A4_due} |
| 5    | Lecture 5, Assignment 5 (Meshes) due {A5_due} |
| 6    | Lecture 6, Assignment 6 (Shader Pipeline) due {A6_due} |
| **Reading Week**  **{reading_week}**   | Study for 1st exam |
| **{midterm}** | In-tutorial Exam (15% of grade) |
| 7    | *Work on Assignments 5 and 6* |
| 8    | Lecture 7, Assignment 7 (Kinematics) due {A7_due} |
| **Sunday, March 15** | Drop date (consider if grade so far is <50%) |
| 9    | Lecture 8, Assignment 8 (Mass-Spring Systems) due {A8_due} |
