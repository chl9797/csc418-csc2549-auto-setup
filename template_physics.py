template = '''# Physics-based Animation __CSC2549 *{term}*__
...
| Week | Topic / Event |
| ---- | :------------ |
| 1    | Introduction, the 1D mass-spring system, Assignment 1 (1D mass-springs) due {A1_due} 
| 2    | Explicit and implicit time integration  
| 3    | Mass-spring systems in three dimensions, Assignment 2 (3D mass-springs) due {A2_due}
| 4    | Finite Elements for simulating nonlinear elastodynamics of solids, Assignment 3 (3D FEM) due {A3_due} 
| 5    | Finite Elements for simulating nonlinear elastodynamics of solids II, Assignment 4 (Cloth simulation) due {A4_due} 
| 6    | Finite Elements for simulating cloth and shells ~~Fluid simulation using Finite Volume Methods~~  
| 7    | Rigid body mechanics, Assignment 5 (Rigid body simulation) due {A5_due} 
| **{drop_date}** | Drop date (consider if grade so far is <50%)  
| 8    | Jointed Rigid Body Systems
| 9    | Collision detection and contact resolution, Assignment 6 (Rigid body collision resolution) due {A6_due} 
| 10   | Collision Detection, Contact Resolution and Fast algorithms for physics-based animation
