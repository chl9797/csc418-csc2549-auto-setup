# Physics-based Animation __CSC2549 *Fall 2020*__
...
| Week | Topic / Event |
| ---- | :------------ |
| 1    | Introduction, the 1D mass-spring system, Assignment 1 (1D mass-springs) due 17/9 
| 2    | Explicit and implicit time integration  
| 3    | Mass-spring systems in three dimensions, Assignment 2 (3D mass-springs) due 24/9
| 4    | Finite Elements for simulating nonlinear elastodynamics of solids, Assignment 3 (3D FEM) due 1/10 
| 5    | Finite Elements for simulating nonlinear elastodynamics of solids II, Assignment 4 (Cloth simulation) due 8/10 
| 6    | Finite Elements for simulating cloth and shells ~~Fluid simulation using Finite Volume Methods~~  
| 7    | Rigid body mechanics, Assignment 5 (Rigid body simulation) due 15/10 
| **Monday, November 9** | Drop date (consider if grade so far is <50%)  
| 8    | Jointed Rigid Body Systems
| 9    | Collision detection and contact resolution, Assignment 6 (Rigid body collision resolution) due 22/10 
